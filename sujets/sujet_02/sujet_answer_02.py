...
class TestSujet02(TestCase):
    def test_correspond_true(self):
        self.assertTrue(correspond("INFORMATIQUE", "INFO*MA*IQUE"))

    def test_correspond_false(self):
        self.assertFalse(correspond("AUTOMATIQUE", "INFO*MA*IQUE"))

    def test_correspond_not_same_lenght(self):
        self.assertFalse(correspond("STOP", "S*"))

    def test_cyclique_false(self):
        self.assertFalse(
            est_cyclique({"A": "E", "F": "A", "C": "D", "E": "B", "B": "F", "D": "C"})
        )

    def test_cyclique_false_2(self):
        self.assertFalse(
            est_cyclique({"A": "B", "F": "A", "C": "D", "E": "C", "B": "F", "D": "E"})
        )

    def test_cyclique_true(self):
        self.assertTrue(
            est_cyclique({"A": "E", "F": "C", "C": "D", "E": "B", "B": "F", "D": "A"})
        )

    def test_cyclique_true_2(self):
        self.assertTrue(
